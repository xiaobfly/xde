...
int main(void)
{
    ...
    // it rejects with C_BAD set.
    {
        ...
        expect_flag("0F 38 2A 66   ok", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0x2A, 0x00}, 5, C_BAD, 0);
        ...
        expect_flag("0F 38 EC none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xEC, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 ED none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xED, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 EE none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xEE, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 EF none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xEF, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 F0 none ok", 64, (const uint8_t[]){0x0F, 0x38, 0xF0, 0x00}, 4, C_BAD, 0);
        expect_flag("0F 38 F0 F3   bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xF0, 0x00}, 5, C_BAD, 1);
        expect_flag("0F 38 F1 none ok", 64, (const uint8_t[]){0x0F, 0x38, 0xF1, 0x00}, 4, C_BAD, 0);
        expect_flag("0F 38 F1 F3   bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xF1, 0x00}, 5, C_BAD, 1);
        expect_flag("0F 38 F2 none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xF2, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 F3 none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xF3, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 F5 66   ok", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xF5, 0x00}, 5, C_BAD, 0);
        expect_flag("0F 38 F5 none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xF5, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 F6 none ok", 64, (const uint8_t[]){0x0F, 0x38, 0xF6, 0x00}, 4, C_BAD, 0);
        expect_flag("0F 38 F6 F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x38, 0xF6, 0x00}, 5, C_BAD, 1);
        expect_flag("0F 38 F7 none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xF7, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 F8 66   ok", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xF8, 0x00}, 5, C_BAD, 0);
        expect_flag("0F 38 F8 none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xF8, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 F9 none ok", 64, (const uint8_t[]){0x0F, 0x38, 0xF9, 0x00}, 4, C_BAD, 0);
        expect_flag("0F 38 F9 66   bad", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xF9, 0x00}, 5, C_BAD, 1);
        expect_flag("0F 38 FA F3   ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xFA, 0xC0}, 5, C_BAD, 0);
        expect_flag("0F 38 FA none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xFA, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 FB F3   ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xFB, 0xC0}, 5, C_BAD, 0);
        expect_flag("0F 38 FB none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xFB, 0x00}, 4, C_BAD, 1);
        expect_flag("0F 38 FC none bad", 64, (const uint8_t[]){0x0F, 0x38, 0xFC, 0x00}, 4, C_BAD, 1);
        ...
        expect_flag("0F 3A F0 F3   ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x3A, 0xF0, 0xC0, 0x90}, 6, C_BAD, 0);
        expect_flag("0F 3A F0 none bad", 64, (const uint8_t[]){0x0F, 0x3A, 0xF0, 0x00, 0x90}, 5, C_BAD, 1);

        // The restricted 0F opcodes the block above does not already pin.
        expect_flag("0F 09 none ok", 64, (const uint8_t[]){0x0F, 0x09}, 2, C_BAD, 0);
        expect_flag("0F 09 66   bad", 64, (const uint8_t[]){0x66, 0x0F, 0x09}, 3, C_BAD, 1);
        expect_flag("0F 13 none ok", 64, (const uint8_t[]){0x0F, 0x13, 0x00}, 3, C_BAD, 0);
        ...
        expect_flag("0F 17 none ok", 64, (const uint8_t[]){0x0F, 0x17, 0x00}, 3, C_BAD, 0);
        ...
        expect_flag("0F 50 none ok", 64, (const uint8_t[]){0x0F, 0x50, 0xC0}, 3, C_BAD, 0);
        ...
        expect_flag("0F 72 none ok", 64, (const uint8_t[]){0x0F, 0x72, 0xD0, 0x90}, 4, C_BAD, 0);
        expect_flag("0F 72 F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x72, 0x00, 0x90}, 5, C_BAD, 1);
        expect_flag("0F 73 none ok", 64, (const uint8_t[]){0x0F, 0x73, 0xD0, 0x90}, 4, C_BAD, 0);
        ...
        expect_flag("0F C5 none ok", 64, (const uint8_t[]){0x0F, 0xC5, 0xC0, 0x90}, 4, C_BAD, 0);
        ...
        expect_flag("0F F4 F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xF4, 0x00}, 4, C_BAD, 1);
        expect_flag("0F F5 none ok", 64, (const uint8_t[]){0x0F, 0xF5, 0x00}, 3, C_BAD, 0);
        expect_flag("0F F5 F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xF5, 0x00}, 4, C_BAD, 1);
        expect_flag("0F F6 none ok", 64, (const uint8_t[]){0x0F, 0xF6, 0x00}, 3, C_BAD, 0);
        expect_flag("0F F6 F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xF6, 0x00}, 4, C_BAD, 1);
        expect_flag("0F F7 none ok", 64, (const uint8_t[]){0x0F, 0xF7, 0xC0}, 3, C_BAD, 0);
        expect_flag("0F F7 F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xF7, 0x00}, 4, C_BAD, 1);
        expect_flag("0F F8 none ok", 64, (const uint8_t[]){0x0F, 0xF8, 0x00}, 3, C_BAD, 0);
        expect_flag("0F F8 F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xF8, 0x00}, 4, C_BAD, 1);
        expect_flag("0F F9 none ok", 64, (const uint8_t[]){0x0F, 0xF9, 0x00}, 3, C_BAD, 0);
        expect_flag("0F F9 F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xF9, 0x00}, 4, C_BAD, 1);
        expect_flag("0F FA none ok", 64, (const uint8_t[]){0x0F, 0xFA, 0x00}, 3, C_BAD, 0);
        expect_flag("0F FA F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xFA, 0x00}, 4, C_BAD, 1);
        expect_flag("0F FB none ok", 64, (const uint8_t[]){0x0F, 0xFB, 0x00}, 3, C_BAD, 0);
        expect_flag("0F FB F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xFB, 0x00}, 4, C_BAD, 1);
        expect_flag("0F FC none ok", 64, (const uint8_t[]){0x0F, 0xFC, 0x00}, 3, C_BAD, 0);
        expect_flag("0F FC F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xFC, 0x00}, 4, C_BAD, 1);
        expect_flag("0F FD none ok", 64, (const uint8_t[]){0x0F, 0xFD, 0x00}, 3, C_BAD, 0);
        expect_flag("0F FD F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xFD, 0x00}, 4, C_BAD, 1);
        expect_flag("0F FE none ok", 64, (const uint8_t[]){0x0F, 0xFE, 0x00}, 3, C_BAD, 0);
        expect_flag("0F FE F2   bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xFE, 0x00}, 4, C_BAD, 1);
    }
    ...
    // The operand forms the SDM gives one class only, checked across both
    // classes and, where /reg selects the operation, across the fields
    // that name nothing: the group shifts and the VIA PadLock forms are
    // register-only, PREFETCH, the Key Locker forms and ENQCMDS are
    // memory-only, the fences are byte-exact, and the MPX bounds are one
    // of four registers. One assertion per class, plus the neighbouring
    // /reg fields that the same mod leaves empty.
    {
        expect_flag("P5 0F 71 none reg m3r2 ok", 64, (const uint8_t[]){0x0F, 0x71, 0xD0, 0x90}, 4, C_BAD, 0);
        expect_flag("P5 0F 71 none reg m3r0 bad", 64, (const uint8_t[]){0x0F, 0x71, 0xC0, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 71 none reg m3r1 bad", 64, (const uint8_t[]){0x0F, 0x71, 0xC8, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 71 none mem m0r0 bad", 64, (const uint8_t[]){0x0F, 0x71, 0x00, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 71 none mem m0r1 bad", 64, (const uint8_t[]){0x0F, 0x71, 0x08, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 71 66   reg m3r2 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x71, 0xD0, 0x90}, 5, C_BAD, 0);
        expect_flag("P5 0F 71 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x71, 0xC0, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 71 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x71, 0xC8, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 71 66   mem m0r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x71, 0x00, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 71 66   mem m0r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x71, 0x08, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 72 none reg m3r2 ok", 64, (const uint8_t[]){0x0F, 0x72, 0xD0, 0x90}, 4, C_BAD, 0);
        expect_flag("P5 0F 72 none reg m3r0 bad", 64, (const uint8_t[]){0x0F, 0x72, 0xC0, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 72 none reg m3r1 bad", 64, (const uint8_t[]){0x0F, 0x72, 0xC8, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 72 none mem m0r0 bad", 64, (const uint8_t[]){0x0F, 0x72, 0x00, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 72 none mem m0r1 bad", 64, (const uint8_t[]){0x0F, 0x72, 0x08, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 72 66   reg m3r2 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x72, 0xD0, 0x90}, 5, C_BAD, 0);
        expect_flag("P5 0F 72 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x72, 0xC0, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 72 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x72, 0xC8, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 72 66   mem m0r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x72, 0x00, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 72 66   mem m0r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x72, 0x08, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 73 none reg m3r2 ok", 64, (const uint8_t[]){0x0F, 0x73, 0xD0, 0x90}, 4, C_BAD, 0);
        expect_flag("P5 0F 73 none reg m3r0 bad", 64, (const uint8_t[]){0x0F, 0x73, 0xC0, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 73 none reg m3r1 bad", 64, (const uint8_t[]){0x0F, 0x73, 0xC8, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 73 none mem m0r0 bad", 64, (const uint8_t[]){0x0F, 0x73, 0x00, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 73 none mem m0r1 bad", 64, (const uint8_t[]){0x0F, 0x73, 0x08, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F 73 66   reg m3r2 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x73, 0xD0, 0x90}, 5, C_BAD, 0);
        expect_flag("P5 0F 73 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x73, 0xC0, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 73 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x73, 0xC8, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 73 66   mem m0r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x73, 0x00, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 73 66   mem m0r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x73, 0x08, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F A6 none reg m3r0 ok", 64, (const uint8_t[]){0x0F, 0xA6, 0xC0}, 3, C_BAD, 0);
        expect_flag("P5 0F A6 none reg m3r3 bad", 64, (const uint8_t[]){0x0F, 0xA6, 0xD8}, 3, C_BAD, 1);
        expect_flag("P5 0F A6 none reg m3r4 bad", 64, (const uint8_t[]){0x0F, 0xA6, 0xE0}, 3, C_BAD, 1);
        expect_flag("P5 0F A6 none mem m0r0 bad", 64, (const uint8_t[]){0x0F, 0xA6, 0x00}, 3, C_BAD, 1);
        expect_flag("P5 0F A6 none mem m0r1 bad", 64, (const uint8_t[]){0x0F, 0xA6, 0x08}, 3, C_BAD, 1);
        expect_flag("P5 0F A6 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xA6, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F A6 66   reg m3r3 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xA6, 0xD8}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 66   reg m3r4 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xA6, 0xE0}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 66   mem m0r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xA6, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 66   mem m0r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xA6, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 F2   reg m3r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0xA6, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F A6 F2   reg m3r3 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xA6, 0xD8}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 F2   reg m3r4 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xA6, 0xE0}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 F2   mem m0r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xA6, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 F2   mem m0r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xA6, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 F3   reg m3r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xA6, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F A6 F3   reg m3r3 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xA6, 0xD8}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 F3   reg m3r4 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xA6, 0xE0}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 F3   mem m0r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xA6, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F A6 F3   mem m0r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xA6, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 none reg m3r0 ok", 64, (const uint8_t[]){0x0F, 0xA7, 0xC0}, 3, C_BAD, 0);
        expect_flag("P5 0F A7 none reg m3r6 bad", 64, (const uint8_t[]){0x0F, 0xA7, 0xF0}, 3, C_BAD, 1);
        expect_flag("P5 0F A7 none reg m3r7 bad", 64, (const uint8_t[]){0x0F, 0xA7, 0xF8}, 3, C_BAD, 1);
        expect_flag("P5 0F A7 none mem m0r0 bad", 64, (const uint8_t[]){0x0F, 0xA7, 0x00}, 3, C_BAD, 1);
        expect_flag("P5 0F A7 none mem m0r1 bad", 64, (const uint8_t[]){0x0F, 0xA7, 0x08}, 3, C_BAD, 1);
        expect_flag("P5 0F A7 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xA7, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F A7 66   reg m3r6 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xA7, 0xF0}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 66   reg m3r7 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xA7, 0xF8}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 66   mem m0r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xA7, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 66   mem m0r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xA7, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 F2   reg m3r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0xA7, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F A7 F2   reg m3r6 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xA7, 0xF0}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 F2   reg m3r7 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xA7, 0xF8}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 F2   mem m0r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xA7, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 F2   mem m0r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xA7, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 F3   reg m3r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xA7, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F A7 F3   reg m3r6 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xA7, 0xF0}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 F3   reg m3r7 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xA7, 0xF8}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 F3   mem m0r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xA7, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F A7 F3   mem m0r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xA7, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F C5 none reg m3r0 ok", 64, (const uint8_t[]){0x0F, 0xC5, 0xC0, 0x90}, 4, C_BAD, 0);
        expect_flag("P5 0F C5 none mem m0r0 bad", 64, (const uint8_t[]){0x0F, 0xC5, 0x00, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F C5 none mem m0r1 bad", 64, (const uint8_t[]){0x0F, 0xC5, 0x08, 0x90}, 4, C_BAD, 1);
        expect_flag("P5 0F C5 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xC5, 0xC0, 0x90}, 5, C_BAD, 0);
        expect_flag("P5 0F C5 66   mem m0r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xC5, 0x00, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F C5 66   mem m0r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xC5, 0x08, 0x90}, 5, C_BAD, 1);
        expect_flag("P5 0F 78 none reg m3r0 ok", 64, (const uint8_t[]){0x0F, 0x78, 0xC0}, 3, C_BAD, 0);
        expect_flag("P5 0F 78 none mem m0r0 ok", 64, (const uint8_t[]){0x0F, 0x78, 0x00}, 3, C_BAD, 0);
        expect_flag("P5 0F 78 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x78, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F 78 66   mem m0r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x78, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F 78 66   mem m0r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x78, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F 78 F2   reg m3r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0x78, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F 78 F2   mem m0r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x78, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F 78 F2   mem m0r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x78, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F 79 none reg m3r0 ok", 64, (const uint8_t[]){0x0F, 0x79, 0xC0}, 3, C_BAD, 0);
        expect_flag("P5 0F 79 none mem m0r0 ok", 64, (const uint8_t[]){0x0F, 0x79, 0x00}, 3, C_BAD, 0);
        expect_flag("P5 0F 79 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x79, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F 79 66   mem m0r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x79, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F 79 66   mem m0r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x79, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F 79 F2   reg m3r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0x79, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F 79 F2   mem m0r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x79, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F 79 F2   mem m0r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x79, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A none reg m3r0 ok", 64, (const uint8_t[]){0x0F, 0x1A, 0xC0}, 3, C_BAD, 0);
        expect_flag("P5 0F 1A none mem m0r0 ok", 64, (const uint8_t[]){0x0F, 0x1A, 0x00}, 3, C_BAD, 0);
        expect_flag("P5 0F 1A none mem m0r0 bad", 64, (const uint8_t[]){0x0F, 0x1A, 0x05, 0x90, 0x90, 0x90, 0x90}, 7, C_BAD, 1);
        expect_flag("P5 0F 1A none mem m0r1 bad", 64, (const uint8_t[]){0x0F, 0x1A, 0x0D, 0x90, 0x90, 0x90, 0x90}, 7, C_BAD, 1);
        expect_flag("P5 0F 1A 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x1A, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F 1A 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x1A, 0xC4}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x1A, 0xCC}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x1A, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F 1A 66   mem m0r4 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x1A, 0x20}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A 66   mem m0r5 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x1A, 0x28}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A F2   reg m3r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0x1A, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F 1A F2   reg m3r4 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x1A, 0xE0}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A F2   reg m3r5 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x1A, 0xE8}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A F2   mem m0r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0x1A, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F 1A F2   mem m0r4 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x1A, 0x20}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A F2   mem m0r5 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x1A, 0x28}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A F3   reg m3r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x1A, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F 1A F3   reg m3r4 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x1A, 0xE0}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A F3   reg m3r5 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x1A, 0xE8}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x1A, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F 1A F3   mem m0r4 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x1A, 0x20}, 4, C_BAD, 1);
        expect_flag("P5 0F 1A F3   mem m0r5 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x1A, 0x28}, 4, C_BAD, 1);
        expect_flag("P5 0F 1B none reg m3r0 ok", 64, (const uint8_t[]){0x0F, 0x1B, 0xC0}, 3, C_BAD, 0);
        expect_flag("P5 0F 1B none mem m0r0 ok", 64, (const uint8_t[]){0x0F, 0x1B, 0x00}, 3, C_BAD, 0);
        expect_flag("P5 0F 1B none mem m0r0 bad", 64, (const uint8_t[]){0x0F, 0x1B, 0x05, 0x90, 0x90, 0x90, 0x90}, 7, C_BAD, 1);
        expect_flag("P5 0F 1B none mem m0r1 bad", 64, (const uint8_t[]){0x0F, 0x1B, 0x0D, 0x90, 0x90, 0x90, 0x90}, 7, C_BAD, 1);
        expect_flag("P5 0F 1B 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x1B, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F 1B 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x1B, 0xC4}, 4, C_BAD, 1);
        expect_flag("P5 0F 1B 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x1B, 0xCC}, 4, C_BAD, 1);
        expect_flag("P5 0F 1B 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x1B, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F 1B 66   mem m0r4 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x1B, 0x20}, 4, C_BAD, 1);
        expect_flag("P5 0F 1B 66   mem m0r5 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x1B, 0x28}, 4, C_BAD, 1);
        expect_flag("P5 0F 1B F2   reg m3r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0x1B, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F 1B F2   reg m3r4 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x1B, 0xE0}, 4, C_BAD, 1);
        expect_flag("P5 0F 1B F2   reg m3r5 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x1B, 0xE8}, 4, C_BAD, 1);
        expect_flag("P5 0F 1B F2   mem m0r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0x1B, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F 1B F2   mem m0r4 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x1B, 0x20}, 4, C_BAD, 1);
        expect_flag("P5 0F 1B F2   mem m0r5 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x1B, 0x28}, 4, C_BAD, 1);
        expect_flag("P5 0F 1B F3   reg m3r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x1B, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F 1B F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x1B, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F 1B F3   mem m0r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x1B, 0x05, 0x90, 0x90, 0x90, 0x90}, 8, C_BAD, 1);
        expect_flag("P5 0F 1B F3   mem m0r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x1B, 0x0D, 0x90, 0x90, 0x90, 0x90}, 8, C_BAD, 1);
        expect_flag("P5 0F C7 none reg m3r6 ok", 64, (const uint8_t[]){0x0F, 0xC7, 0xF0}, 3, C_BAD, 0);
        expect_flag("P5 0F C7 none reg m3r0 bad", 64, (const uint8_t[]){0x0F, 0xC7, 0xC0}, 3, C_BAD, 1);
        expect_flag("P5 0F C7 none reg m3r1 bad", 64, (const uint8_t[]){0x0F, 0xC7, 0xC8}, 3, C_BAD, 1);
        expect_flag("P5 0F C7 none mem m0r1 ok", 64, (const uint8_t[]){0x0F, 0xC7, 0x08}, 3, C_BAD, 0);
        expect_flag("P5 0F C7 none mem m0r0 bad", 64, (const uint8_t[]){0x0F, 0xC7, 0x00}, 3, C_BAD, 1);
        expect_flag("P5 0F C7 none mem m0r2 bad", 64, (const uint8_t[]){0x0F, 0xC7, 0x10}, 3, C_BAD, 1);
        expect_flag("P5 0F C7 66   reg m3r6 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xC7, 0xF0}, 4, C_BAD, 0);
        expect_flag("P5 0F C7 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xC7, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xC7, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 66   mem m0r1 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xC7, 0x08}, 4, C_BAD, 0);
        expect_flag("P5 0F C7 66   mem m0r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xC7, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 66   mem m0r2 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xC7, 0x10}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 F2   reg m3r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xC7, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 F2   reg m3r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xC7, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 F2   mem m0r1 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0xC7, 0x08}, 4, C_BAD, 0);
        expect_flag("P5 0F C7 F2   mem m0r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xC7, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 F2   mem m0r2 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xC7, 0x10}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 F3   reg m3r6 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xC7, 0xF0}, 4, C_BAD, 0);
        expect_flag("P5 0F C7 F3   reg m3r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xC7, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xC7, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 F3   mem m0r1 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xC7, 0x08}, 4, C_BAD, 0);
        expect_flag("P5 0F C7 F3   mem m0r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xC7, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F C7 F3   mem m0r2 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xC7, 0x10}, 4, C_BAD, 1);
        expect_flag("P5 0F AE none reg m3r5 ok", 64, (const uint8_t[]){0x0F, 0xAE, 0xE8}, 3, C_BAD, 0);
        expect_flag("P5 0F AE none reg m3r0 bad", 64, (const uint8_t[]){0x0F, 0xAE, 0xC0}, 3, C_BAD, 1);
        expect_flag("P5 0F AE none reg m3r1 bad", 64, (const uint8_t[]){0x0F, 0xAE, 0xC8}, 3, C_BAD, 1);
        expect_flag("P5 0F AE none mem m0r0 ok", 64, (const uint8_t[]){0x0F, 0xAE, 0x00}, 3, C_BAD, 0);
        expect_flag("P5 0F AE 66   reg m3r6 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xAE, 0xF0}, 4, C_BAD, 0);
        expect_flag("P5 0F AE 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xAE, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F AE 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xAE, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F AE 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xAE, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F AE 66   mem m0r4 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xAE, 0x20}, 4, C_BAD, 1);
        expect_flag("P5 0F AE 66   mem m0r5 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xAE, 0x28}, 4, C_BAD, 1);
        expect_flag("P5 0F AE F2   reg m3r6 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0xAE, 0xF0}, 4, C_BAD, 0);
        expect_flag("P5 0F AE F2   reg m3r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xAE, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F AE F2   reg m3r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xAE, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F AE F2   mem m0r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0xAE, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F AE F2   mem m0r4 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xAE, 0x20}, 4, C_BAD, 1);
        expect_flag("P5 0F AE F2   mem m0r5 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xAE, 0x28}, 4, C_BAD, 1);
        expect_flag("P5 0F AE F3   reg m3r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xAE, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F AE F3   reg m3r7 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xAE, 0xF9}, 4, C_BAD, 1);
        expect_flag("P5 0F AE F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xAE, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F AE F3   mem m0r5 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xAE, 0x28}, 4, C_BAD, 1);
        expect_flag("P5 0F AE F3   mem m0r7 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xAE, 0x38}, 4, C_BAD, 1);
        expect_flag("P5 0F 0D none reg m3r0 bad", 64, (const uint8_t[]){0x0F, 0x0D, 0xC0}, 3, C_BAD, 1);
        expect_flag("P5 0F 0D none reg m3r1 bad", 64, (const uint8_t[]){0x0F, 0x0D, 0xC8}, 3, C_BAD, 1);
        expect_flag("P5 0F 0D none mem m0r0 ok", 64, (const uint8_t[]){0x0F, 0x0D, 0x00}, 3, C_BAD, 0);
        expect_flag("P5 0F 0D 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x0D, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F 0D 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x0D, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F 0D 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x0D, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F 0D F2   reg m3r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x0D, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F 0D F2   reg m3r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x0D, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F 0D F2   mem m0r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0x0D, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F 0D F3   reg m3r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x0D, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F 0D F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x0D, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F 0D F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x0D, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F B2 none reg m3r0 bad", 64, (const uint8_t[]){0x0F, 0xB2, 0xC0}, 3, C_BAD, 1);
        expect_flag("P5 0F B2 none reg m3r1 bad", 64, (const uint8_t[]){0x0F, 0xB2, 0xC8}, 3, C_BAD, 1);
        expect_flag("P5 0F B2 none mem m0r0 ok", 64, (const uint8_t[]){0x0F, 0xB2, 0x00}, 3, C_BAD, 0);
        expect_flag("P5 0F B2 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xB2, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F B2 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xB2, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F B2 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xB2, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F B2 F2   reg m3r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xB2, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F B2 F2   reg m3r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xB2, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F B2 F2   mem m0r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0xB2, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F B2 F3   reg m3r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xB2, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F B2 F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xB2, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F B2 F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xB2, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F B4 none reg m3r0 bad", 64, (const uint8_t[]){0x0F, 0xB4, 0xC0}, 3, C_BAD, 1);
        expect_flag("P5 0F B4 none reg m3r1 bad", 64, (const uint8_t[]){0x0F, 0xB4, 0xC8}, 3, C_BAD, 1);
        expect_flag("P5 0F B4 none mem m0r0 ok", 64, (const uint8_t[]){0x0F, 0xB4, 0x00}, 3, C_BAD, 0);
        expect_flag("P5 0F B4 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xB4, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F B4 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xB4, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F B4 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xB4, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F B4 F2   reg m3r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xB4, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F B4 F2   reg m3r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xB4, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F B4 F2   mem m0r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0xB4, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F B4 F3   reg m3r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xB4, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F B4 F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xB4, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F B4 F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xB4, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F B5 none reg m3r0 bad", 64, (const uint8_t[]){0x0F, 0xB5, 0xC0}, 3, C_BAD, 1);
        expect_flag("P5 0F B5 none reg m3r1 bad", 64, (const uint8_t[]){0x0F, 0xB5, 0xC8}, 3, C_BAD, 1);
        expect_flag("P5 0F B5 none mem m0r0 ok", 64, (const uint8_t[]){0x0F, 0xB5, 0x00}, 3, C_BAD, 0);
        expect_flag("P5 0F B5 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xB5, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F B5 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xB5, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F B5 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xB5, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F B5 F2   reg m3r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xB5, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F B5 F2   reg m3r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xB5, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F B5 F2   mem m0r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0xB5, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F B5 F3   reg m3r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xB5, 0xC0}, 4, C_BAD, 1);
        expect_flag("P5 0F B5 F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xB5, 0xC8}, 4, C_BAD, 1);
        expect_flag("P5 0F B5 F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xB5, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F D6 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xD6, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F D6 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xD6, 0x00}, 4, C_BAD, 0);
        expect_flag("P5 0F D6 F2   reg m3r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0xD6, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F D6 F2   mem m0r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xD6, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F D6 F2   mem m0r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xD6, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F D6 F3   reg m3r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xD6, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F D6 F3   mem m0r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xD6, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F D6 F3   mem m0r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xD6, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F D7 none reg m3r0 ok", 64, (const uint8_t[]){0x0F, 0xD7, 0xC0}, 3, C_BAD, 0);
        expect_flag("P5 0F D7 none mem m0r0 bad", 64, (const uint8_t[]){0x0F, 0xD7, 0x00}, 3, C_BAD, 1);
        expect_flag("P5 0F D7 none mem m0r1 bad", 64, (const uint8_t[]){0x0F, 0xD7, 0x08}, 3, C_BAD, 1);
        expect_flag("P5 0F D7 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0xD7, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F D7 66   mem m0r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xD7, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F D7 66   mem m0r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0xD7, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F D7 F2   reg m3r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0xD7, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F D7 F2   mem m0r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xD7, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F D7 F2   mem m0r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0xD7, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F D7 F3   reg m3r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0xD7, 0xC0}, 4, C_BAD, 0);
        expect_flag("P5 0F D7 F3   mem m0r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xD7, 0x00}, 4, C_BAD, 1);
        expect_flag("P5 0F D7 F3   mem m0r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0xD7, 0x08}, 4, C_BAD, 1);
        expect_flag("P5 0F 38 D8 F3   reg m3r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xD8, 0xC0}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 D8 F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xD8, 0xC8}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 D8 F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xD8, 0x00}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 D8 F3   mem m0r4 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xD8, 0x20}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 D8 F3   mem m0r5 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xD8, 0x28}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 DD 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xDD, 0xC0}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 DD 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xDD, 0x00}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 DD F3   reg m3r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xDD, 0xC0}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 DD F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xDD, 0xC8}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 DD F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xDD, 0x00}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 DE 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xDE, 0xC0}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 DE 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xDE, 0x00}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 DE F3   reg m3r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xDE, 0xC0}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 DE F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xDE, 0xC8}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 DE F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xDE, 0x00}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 DF 66   reg m3r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xDF, 0xC0}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 DF 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xDF, 0x00}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 DF F3   reg m3r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xDF, 0xC0}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 DF F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xDF, 0xC8}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 DF F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xDF, 0x00}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 F8 66   reg m3r0 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xF8, 0xC0}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 F8 66   reg m3r1 bad", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xF8, 0xC8}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 F8 66   mem m0r0 ok", 64, (const uint8_t[]){0x66, 0x0F, 0x38, 0xF8, 0x00}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 F8 F2   reg m3r0 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x38, 0xF8, 0xC0}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 F8 F2   reg m3r1 bad", 64, (const uint8_t[]){0xF2, 0x0F, 0x38, 0xF8, 0xC8}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 F8 F2   mem m0r0 ok", 64, (const uint8_t[]){0xF2, 0x0F, 0x38, 0xF8, 0x00}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 F8 F3   reg m3r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xF8, 0xC0}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 F8 F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xF8, 0xC8}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 F8 F3   mem m0r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xF8, 0x00}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 FA F3   reg m3r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xFA, 0xC0}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 FA F3   mem m0r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xFA, 0x00}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 FA F3   mem m0r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xFA, 0x08}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 FB F3   reg m3r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xFB, 0xC0}, 5, C_BAD, 0);
        expect_flag("P5 0F 38 FB F3   mem m0r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xFB, 0x00}, 5, C_BAD, 1);
        expect_flag("P5 0F 38 FB F3   mem m0r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x38, 0xFB, 0x08}, 5, C_BAD, 1);
        expect_flag("P5 0F 3A F0 F3   reg m3r0 ok", 64, (const uint8_t[]){0xF3, 0x0F, 0x3A, 0xF0, 0xC0, 0x90}, 6, C_BAD, 0);
        expect_flag("P5 0F 3A F0 F3   reg m3r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x3A, 0xF0, 0xC8, 0x90}, 6, C_BAD, 1);
        expect_flag("P5 0F 3A F0 F3   reg m3r2 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x3A, 0xF0, 0xD0, 0x90}, 6, C_BAD, 1);
        expect_flag("P5 0F 3A F0 F3   mem m0r0 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x3A, 0xF0, 0x00, 0x90}, 6, C_BAD, 1);
        expect_flag("P5 0F 3A F0 F3   mem m0r1 bad", 64, (const uint8_t[]){0xF3, 0x0F, 0x3A, 0xF0, 0x08, 0x90}, 6, C_BAD, 1);
    }

    // The /reg fields and rm values the class sweep above cannot reach,
    // spelled out: the 66 group shift selects PSRLDQ and PSLLDQ at /3 and
    // /7 while the bare form has neither, the fence slot is byte-exact for
    // MFENCE and SFENCE but not for LFENCE (binutils names the rm=1 form,
    // the LLVM tables do not, and the SDM's table leaves it blank, so the
    // flag stays clear), and the 66 and F2 /5 of 0F AE name nothing where the
    // F3 /5 is INCSSPD.
    {
        static const uint8_t psrldq[]        = { 0x66, 0x0F, 0x73, 0xD8, 0x12 };
        static const uint8_t pslldq[]        = { 0x66, 0x0F, 0x73, 0xF8, 0x12 };
        static const uint8_t psrldq_bare[]   = { 0x0F, 0x73, 0xD8, 0x12 };
        static const uint8_t pslldq_bare[]   = { 0x0F, 0x73, 0xF8, 0x12 };
        static const uint8_t mfence_rm1[]    = { 0x0F, 0xAE, 0xF1 };
        static const uint8_t sfence_rm1[]    = { 0x0F, 0xAE, 0xF9 };
        static const uint8_t sfence_66_rm1[] = { 0x66, 0x0F, 0xAE, 0xF9 };
        static const uint8_t sfence_f3_rm1[] = { 0xF3, 0x0F, 0xAE, 0xF9 };
        static const uint8_t lfence_rm1[]    = { 0x0F, 0xAE, 0xE9 };
        static const uint8_t tpause_rm1[]    = { 0x66, 0x0F, 0xAE, 0xF1 };
        static const uint8_t umonitor_rm1[]  = { 0xF3, 0x0F, 0xAE, 0xF1 };
        static const uint8_t lfence_66[]     = { 0x66, 0x0F, 0xAE, 0xE8 };
        static const uint8_t lfence_f2[]     = { 0xF2, 0x0F, 0xAE, 0xE8 };
        static const uint8_t incsspd_rm0[]   = { 0xF3, 0x0F, 0xAE, 0xE8 };
        static const uint8_t montmul_rm1[]   = { 0x0F, 0xA6, 0xC1 };
        static const uint8_t xcrypt_rm1[]    = { 0x0F, 0xA7, 0xC9 };
        static const uint8_t hreset_rm1[]    = { 0xF3, 0x0F, 0x3A, 0xF0, 0xC1, 0x12 };
        expect_flag("66 0F 73 /3 PSRLDQ ok", 64, psrldq, 5, C_BAD, 0);
        expect_flag("66 0F 73 /7 PSLLDQ ok", 64, pslldq, 5, C_BAD, 0);
        expect_flag("0F 73 /3 bare bad", 64, psrldq_bare, 4, C_BAD, 1);
        expect_flag("0F 73 /7 bare bad", 64, pslldq_bare, 4, C_BAD, 1);
        expect_flag("MFENCE rm=1 bad", 64, mfence_rm1, 3, C_BAD, 1);
        expect_flag("SFENCE rm=1 bad", 64, sfence_rm1, 3, C_BAD, 1);
        expect_flag("66 SFENCE rm=1 bad", 64, sfence_66_rm1, 4, C_BAD, 1);
        expect_flag("F3 SFENCE rm=1 bad", 64, sfence_f3_rm1, 4, C_BAD, 1);
        expect_flag("LFENCE rm=1 ok", 64, lfence_rm1, 3, C_BAD, 0);
        expect_flag("66 0F AE /6 TPAUSE rm=1 ok", 64, tpause_rm1, 4, C_BAD, 0);
        expect_flag("F3 0F AE /6 UMONITOR rm=1 ok", 64, umonitor_rm1, 4, C_BAD, 0);
        expect_flag("66 0F AE /5 bad", 64, lfence_66, 4, C_BAD, 1);
        expect_flag("F2 0F AE /5 bad", 64, lfence_f2, 4, C_BAD, 1);
        expect_flag("F3 0F AE /5 INCSSPD ok", 64, incsspd_rm0, 4, C_BAD, 0);
        expect_flag("MONTMUL rm=1 bad", 64, montmul_rm1, 3, C_BAD, 1);
        expect_flag("XCRYPT rm=1 bad", 64, xcrypt_rm1, 3, C_BAD, 1);
        expect_flag("HRESET rm=1 bad", 64, hreset_rm1, 6, C_BAD, 1);
    }
