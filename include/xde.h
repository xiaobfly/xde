...
// 8-bit low-byte forms of r8-r15 (r8b..r15b). Additive: the width-agnostic
// XSET_R8..XSET_R15 bits are still set, these only add the width detail.
#define XSET2_R8B   0x0000000000010000ULL
#define XSET2_R9B   0x0000000000020000ULL
#define XSET2_R10B  0x0000000000040000ULL
#define XSET2_R11B  0x0000000000080000ULL
#define XSET2_R12B  0x0000000000100000ULL
#define XSET2_R13B  0x0000000000200000ULL
#define XSET2_R14B  0x0000000000400000ULL
#define XSET2_R15B  0x0000000000800000ULL
#define XSET2_ALL   0x0000000000FFFFFFULL
