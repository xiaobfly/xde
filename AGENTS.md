...
| `tools/gen_tables.py:9` / `:89-544` / `:655-675` | 输出路径 / 全部表数据 / emit 块 |
...
1. `tools/gen_tables.py:89-544` 里改对应的 Python map（`m0` = legacy、`m1` = 0F、`m2` = 0F38、`m3` = 0F3A、`m4-m6` = EVEX 4-6、`m7` = VEX 7、`m8`/`m9`/`ma` = XOP 8/9/A）；
